...
const reducer = function (state, action) {
	...
	switch (action.type) {
		case "openAccount":
			return { ...state, isActive: true, balance: STARTING_BALANCE };
...
function App() {
	...
	// derived state for closing account (only for UI)
	const accountClosePossible = isActive && balance === 0 && loan === 0;
